...
class PodioImporter extends PodioObject
{
     ...
     */
    public static function info($file_id, PodioClient $podio_client)
    {
     ...
     */
    public static function preview($file_id, $row, $attributes = array(), PodioClient $podio_client)
    {
     ...
     */
    public static function process_app($file_id, $app_id, $attributes = array(), PodioClient $podio_client)
    {
     ...
     */
    public static function process_contacts($file_id, $space_id, $attributes = array(), PodioClient $podio_client)
    {
