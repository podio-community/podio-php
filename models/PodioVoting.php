...
class PodioVoting extends PodioObject
{
     ...
     */
    public static function get_result_for_item($item_id, $voting_id, PodioClient $podio_client)
    {
     ...
     */
    public static function get_voting_id($app_id, PodioClient $podio_client)
    {
     ...
     */
    public static function get_list_of_users_with_votes($item_id, $voting_id, PodioClient $podio_client)
    {
