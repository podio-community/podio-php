...
class PodioItem extends PodioSuperApp {
  ...
  /**
  * $itemCount = PodioItem::get_item_count( $appId );
  * returns (int)
  */
  public static function get_item_count($app_id) {
    $info = Podio::get("/item/app/{$app_id}/count");
    $itemCount = json_decode($info->body);
